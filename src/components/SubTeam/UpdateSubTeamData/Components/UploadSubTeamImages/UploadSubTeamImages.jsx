...
import styles from './UploadSubTeamImages.module.css';

export default function UploadSubTeamImages({ communityId, teamId, subTeamId, refetch }) {
  const API_BASE_URL = `${import.meta.env.VITE_BASE_URL}/api/communities/${communityId}/teams/${teamId}/subteams/${subTeamId}/images`;
  ...
  return (
    <div className={`${styles.uploadSubTeamImages}`}>
      {/* Header and drop zone */}
      <div className={styles.header}>
        <h4 className={styles.title}>Sub-Team Images</h4>
      </div>

      <div className={`${styles.uploadZone}`}>
        <label className={`${styles.subTeamBanner}`} htmlFor="subTeamBanner">
          <div
      ...
      {/* Status messages and image grid */}
