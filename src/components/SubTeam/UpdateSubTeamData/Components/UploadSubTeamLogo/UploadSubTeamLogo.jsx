...
import styles from "./UploadSubTeamLogo.module.css";

const baseUrl = import.meta.env.VITE_BASE_URL;

export default function UploadSubTeamLogo({ communityId, teamId, subTeamId, refetch }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const url = `${baseUrl}/api/communities/${communityId}/teams/${teamId}/subteams/${subTeamId}/logo`;
  ...
  return (
    <div className={`${styles.logoUpload}`}>
      <label htmlFor="subTeamLogo" className={`${styles.uploadLabel}`}>
      ...
      <p className={styles.labelText}>Sub-Team Logo</p>
