...
export default function TeamOverview({ safeData }) {
    const stats = [
        {
            ...
            <div className={styles.teamInfo}>
                <div className={styles.aboutTeam}>
                    <div className={styles.sectionHeader}>
                        ...
                        <h4 className={styles.title}>
                            {safeData.Name || "Team Name"}
                        </h4>
                    </div>
                    <div className={styles.descriptionBox}>
                        <p className={styles.desc}>
                            {safeData.Desc || "No description available for this team."}
                        </p>
                ...
                <div className={styles.teamVision}>
                    ...
                    <div className={styles.visionContent}>
                        ...
                        <p className={styles.desc}>
                            {safeData.Vision || "No vision statement available for this team."}
                        </p>
                        <div className={styles.quoteIcon}>
