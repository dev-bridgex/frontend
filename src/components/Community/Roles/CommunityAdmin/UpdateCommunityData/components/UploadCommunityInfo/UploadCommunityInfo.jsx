...
import styles from "./UploadCommunityInfo.module.css";
...
// Validation schema
// Updated validation schema to match CommunityUpdateDto
...
export default function UploadCommunityInfo({ communityId, refetch }) {
  // Form state
  ...
  useEffect(() => {
    const validateForm = async () => {
      try {
        await communityInfoSchema.validate(
          { ...formData, links },
          { abortEarly: false }
        );
        setFormErrors({});
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg = error.response?.data?.Message ||
        error.message ||
        "Failed to update community info";
  ...
  return (
    <section className={styles.UploadCommunityInfo}>
      ...
      <form className={styles.infoSection} onSubmit={handleSubmit}>
        ...
        <div className={styles.formGroup}>
          ...
          <textarea
            id="shortDesc"
            rows="2"
            placeholder="Brief description of your community (max 80 characters)"
        ...
        <div className={styles.formGroup}>
          ...
          <textarea
            id="desc"
            rows="5"
            placeholder="Detailed description of your community (max 325 characters)"
            value={formData.desc}
            onChange={handleInputChange}
        ...
        <div className={styles.formGroup}>
          ...
          <textarea
            id="vision"
            rows="4"
            placeholder="Your community's vision and goals (max 325 characters)"
            ...
            {submitSuccess && (
              <div className={styles.successMessage}>
                <div className={styles.messageContent}>
                  ...
                  <span>Community information updated successfully!</span>
                </div>
              </div>
            )}
          </div>
